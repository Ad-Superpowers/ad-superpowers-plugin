...
description: |
  Diagnose and fix common LinkedIn Ads performance problems. Covers high CPL issues, low engagement, delivery problems, and budget optimization for the highest-cost B2B ad platform ($5.58 avg CPC).

  Use when: user asks about high LinkedIn CPL, ads not spending, low engagement despite impressions, reducing LinkedIn ad costs, or sudden performance drops on LinkedIn.
---
