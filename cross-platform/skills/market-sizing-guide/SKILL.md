...
description: |
  Comprehensive guide for calculating TAM (Total Addressable Market), SAM (Serviceable Addressable Market),
  and SOM (Serviceable Obtainable Market) for advertising budget planning. Includes methodology frameworks,
  industry benchmarks, and advertising-specific calculations.

  Use when: user asks about market sizing, TAM/SAM/SOM calculations, budget planning based on market opportunity,
  addressable audience size, or strategic budget allocation for new markets.
---
