...
description: |
  Framework for creating data-driven buyer personas for advertising campaigns. Includes templates,
  platform-specific targeting translations, and industry-specific persona archetypes.

  Use when: user asks about creating personas, defining target audiences, audience research,
  customer segmentation, or needs help translating personas into ad targeting parameters.
---
