...
description: |
  Comprehensive guide to building a privacy-first data strategy for advertising measurement and targeting.
  Covers first-party data collection, server-side tracking, Consent Mode V2, Customer Data Platforms (CDPs),
  and data clean rooms. Essential for maintaining measurement quality in the post-cookie era.

  Use when: user asks about first-party data, server-side tracking, CAPI, Consent Mode, privacy-first
  measurement, CDP selection, data collection strategy, GDPR-compliant tracking, Enhanced Conversions,
  cookieless advertising, or preparing for cookie deprecation.
---
