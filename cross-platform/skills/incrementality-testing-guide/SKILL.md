...
description: |
  Comprehensive guide to measuring true advertising impact through incrementality testing.
  Covers geo lift tests, holdout experiments, conversion lift studies, and synthetic control methods.
  Includes statistical significance explanation, test design principles, and when testing is/isn't appropriate.

  Use when: user asks about incrementality testing, geo lift tests, holdout tests, measuring true ad impact,
  whether advertising is actually working, attribution beyond last-click, conversion lift, A/B testing for
  media, MMM basics, or understanding true ROAS (iROAS).
---
