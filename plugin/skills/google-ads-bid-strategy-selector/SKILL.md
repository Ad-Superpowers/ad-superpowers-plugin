...
description: |
  ...
  comparing tCPA vs tROAS, portfolio bid strategies, bid adjustments, learning phase management,
  value-based bidding, migration from manual to Smart Bidding.
...
├── If you spend EUR100, you need to generate EUR250 in revenue
...
├── You want a single point for bid management
