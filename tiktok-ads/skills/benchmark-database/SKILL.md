...
description: "Referentiedatabase met industry benchmarks voor TikTok Ads metrics per branche, campagnetype en ad format. Gebruik deze skill wanneer je wilt weten of je TikTok metrics goed presteren of wanneer je targets moet bepalen. Triggers: tiktok benchmark, tiktok CPM, tiktok CTR, tiktok CPC, tiktok CVR, is my CPM good, tiktok average, spark ads benchmark."
---
...
Deze skill biedt een uitgebreide database met TikTok Ads benchmarks per industrie, ad format, objective en creative type, zodat je kunt beoordelen hoe je metrics presteren ten opzichte van marktstandaarden.
...
├── Bronnen: TikTok Ads Help Center, Advertisers, Industry Reports
├── Primair gericht op US/EU markten
└── Focus op e-commerce & DTC brands

TikTok Specifieke Factoren:
├── Creative fatigue is 4x sneller dan Meta
├── Video quality impact is significant
├── Hook performance (first 2 sec) cruciaal
├── UGC outperforms polished content vaak
└── Seasonal spikes zijn extremer (TikTok Shop)
```
...
├── Traffic: 1.0-2.5%
├── Video Views: 0.3-1.0% (focus op view rate)
├── Conversions: 1.5-3.5%
...
├── Critical metric voor TikTok success
├── Target: >50% 2-second view rate
├── <30% = Hook faalt, creative refresh nodig
...
**Gebruiker**: "Mijn TikTok beauty campaign heeft een CTR van 1.8%, CVR van 3.5% en CPM van €9. Is dat goed?"

**Claude response**:

"Laat me je metrics vergelijken met beauty/cosmetics benchmarks:

---

**BENCHMARK VERGELIJKING - Beauty/Cosmetics:**

| Metric | Jouw Waarde | Benchmark Range | Status |
|--------|-------------|-----------------|--------|
| CTR | 1.8% | 0.8-1.5% (average) | 🟢 Excellent |
| CVR | 3.5% | 2-4% (average) | 🟡 Good |
| CPM | €9 | €5-10 (average) | 🟡 OK |

**Berekende Metrics:**
- CPC: €9 / (1.8% × 10) = €0.50 → 🟢 Good for beauty
- CPA: €9 / (1.8% × 3.5% / 100) = €14.29 → 🟢 Excellent

---

**INTERPRETATIE:**

✅ **CTR (1.8%)** - 20% boven average. Je creative/hook werkt goed.

🟡 **CVR (3.5%)** - Precies in de average range. Ruimte voor verbetering op de landing page of product page.

🟡 **CPM (€9)** - Normaal voor beauty. Niet te hoog, niet uitzonderlijk laag.

---

**AANBEVELINGEN:**

1. **Behoud je creative strategie** - CTR is sterk, dus je hook werkt

2. **Focus op CVR verbetering**:
   - Test landing page optimizations
   - Probeer TikTok Shop (vaak +25% CVR)
   - Add reviews/social proof

3. **Monitor creative fatigue**:
   - Bij TikTok: refresh na 7-10 dagen
   - Als CTR >15% daalt → nieuwe creative nodig

4. **Scale potential**: Met CPA van €14.29 en beauty benchmark €10-22, kun je veilig budget verhogen.

Wil je dat ik je hook performance (2-second view rate) analyseer voor meer inzicht?"
