...
description: |
  Track, analyze, and optimize TikTok app install campaigns. Covers app event metrics, MMP (AppsFlyer, Adjust, Branch) data reconciliation, iOS 14+ SKAN attribution, and CPI benchmarks by vertical (Gaming €2.10, Finance €6.50, E-commerce €3.20).
...
- **Install tracking:** "Hoeveel app installs krijg ik?"
- **CPI analysis:** "Wat is mijn cost per install?"
- **MMP discrepancies:** "Waarom matchen TikTok en AppsFlyer niet?"
- **iOS tracking:** "Hoeveel iOS installs via SKAN?"
- **In-app events:** "Hoeveel registraties na install?"
- **Retention:** "Wat is mijn D2 retention?"
- **Gaming metrics:** "Hoeveel users completen de tutorial?"
- **Subscription apps:** "Wat is mijn cost per trial?"
