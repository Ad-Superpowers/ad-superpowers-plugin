...
description: "Complete GAQL reference for Google Ads API v23. Use for: (1) Writing GAQL queries, (2) Metric and dimension selection, (3) Date range filtering, (4) v23 migration (video_views → video_trueview_views), (5) Common query patterns. Triggers: gaql, google ads query, metrics, report, video_views, LAST_90_DAYS."
---
...
4. Use `google_ads_run_gaql` for all queries — it supports any GAQL query
5. Use `google_ads_run_keyword_planner` for keyword research and volume estimates
6. Use `google_ads_mutate` for campaign creation and updates
